      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
        ...
        <aside className="lg:col-span-4 space-y-8 fade-in-up">
          ...
          <p className="text-xs text-[#d1c5b4]/80 leading-relaxed font-light">
            A chronicler of fleeting moments and digital echoes within the Seasons.
          </p>
          ...
          <div className="border border-white/10 bg-[#161920]/80 p-6 space-y-3 relative overflow-hidden">
            ...
            <p className="text-[11px] text-[#d1c5b4]/70 leading-relaxed italic">
              "Reached the conceptual core of the current exhibition space, unlocking abstract visual planes."
            </p>
          </div>
        </aside>
